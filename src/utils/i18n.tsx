    ...
    resources: {
      en: {
        translations: {
          ...
          rsvpMeal2: "Beef",
          rsvpMeal3: "Salmon",
          rsvpClosedTitle: "Dear friends and loved ones,",
          rsvpClosedBody1: "We extend our heartfelt thanks to those who have confirmed their attendance to our wedding. Your love and support mean the world to us, and we can't wait to share this special day with each one of you.",
          rsvpClosedBody2: "In the coming days, we will send you an email to ensure you have all the necessary details to join us for this memorable occasion.",
          rsvpClosedDeadline: "Please remember that the last day to confirm your attendance was August 16th.",
          rsvpMessageLabel: "Message",
          rsvpSubmitButton: "Send",
          registryTitle: "Registry",
          registryBody: "We’re lucky enough to have nearly everything we need for our home already. If you want to help making our honeymoon unforgettable, you can contribute using the following information:",
      ...
      es: {
        translations: {
          ...
          rsvpClosedTitle: "Amigos y seres queridos,",
          rsvpClosedBody1: "Queremos expresar nuestro más sincero agradecimiento a aquellos que han confirmado su asistencia a nuestra boda. Su amor y apoyo significan mucho para nosotros, y no podemos esperar para compartir este día especial con cada uno de ustedes.",
          rsvpClosedBody2: "En los próximos días, les enviaremos un correo electrónico para asegurarnos de que tengan todos los detalles necesarios para unirse a nosotros en esta ocasión memorable.",
          rsvpClosedDeadline: "Recuerda que el último día para confirmar asistencia fue el 16 de agosto.",
